  ...
  function stations(client, prefix, message) {
      ...
      const infoembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("130 Radio Stations", client.user.displayAvatarURL(), " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(`
      ...
      const United_Kingdomembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("United_Kingdom - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-united-kingdom_1f1ec-1f1e7.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(United_Kingdom)
      const austriaembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Austria - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-austria_1f1e6-1f1f9.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(austria)
      const Belgiumembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Belgium - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-belgium_1f1e7-1f1ea.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Belgium)
      const Bosniaembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Bosnia & Herzegovina - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-bosnia-herzegovina_1f1e7-1f1e6.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Bosnia)
      const Czechembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Czech - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-czechia_1f1e8-1f1ff.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Czech)
      const Denmarkembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Denmark - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-denmark_1f1e9-1f1f0.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Denmark)
      const germanyembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Germany - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-germany_1f1e9-1f1ea.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(germany)
      const Hungaryembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Hungary - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-hungary_1f1ed-1f1fa.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Hungary)
      const Irelandembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Ireland - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-ireland_1f1ee-1f1ea.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Ireland)
      const Italyembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Italy - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-italy_1f1ee-1f1f9.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Italy)
      const Luxembourgembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Luxembourg - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-luxembourg_1f1f1-1f1fa.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Luxembourg)
      const Romaniaembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Romania - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-romania_1f1f7-1f1f4.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Romania)
      const Serbiaembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Serbia - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-serbia_1f1f7-1f1f8.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Serbia)
      const Spainembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Romania - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-spain_1f1ea-1f1f8.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Spain)
      const Swedenembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Sweden - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-sweden_1f1f8-1f1ea.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Sweden)
      const TURKEYembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Turkey - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-turkey_1f1f9-1f1f7.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(TURKEY)
      const Ukraineembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Ukraine - Radio Stations", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/259/flag-ukraine_1f1fa-1f1e6.png", " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
          .setDescription(Ukraine)

      const Reqeustembed = new Discord.MessageEmbed()
          .setColor("#7fafe3")
          .setAuthor("Reqeusted - Radio Stations", client.user.displayAvatarURL(), " https://BYOMKESH")
          .setFooter(client.user.username, client.user.displayAvatarURL())
