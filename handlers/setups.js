    ...
    function getAll(client, guild) {
        const embed = new MessageEmbed()
            ...
            .addField("**__BOT BY:__**", `
                >>> <@442355791412854784> \`Tomato#6966\` [\`Website\`](https://BYOMKESH) [\`INVITE\`](https://discord.com/api/oauth2/authorize?client_id=789845410998779904&permissions=8&scope=bot)
                `)
