...
module.exports = {
	...
	run: async (client, message, args) => {
			message.channel.send(new MessageEmbed()
				...
				.setFooter("Musicium | by: BYOMKESH", client.user.displayAvatarURL())
				.setTimestamp()
				...
				.setDescription(`
			> Hello I am **Tomato** <@442355791412854784> *(\`Tomato#6966\`)*, and i made more then 200 different Discord Bots: [My WEBSITE](https://BYOMKESH)
			...
			> Even more proud, or as proud I am about: [**Lava Music** | \`2021's Best Music Bot\`](https://lava.BYOMKESH) <@742672021422342165>

			> I made this Bot, and you can get a free Bot too! Just go to: [My Service](https://BYOMKESH)
 ...
 * @INFO
 * Work for Milrato Development | https://BYOMKESH
 * @INFO
